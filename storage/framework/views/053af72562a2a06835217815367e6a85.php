...
<div>
    <div>
        <a href="#" data-toggle="modal" data-target="#loginAndRegistrationModal" style="color: #fff;"><?php echo e(__('messages.logReg')); ?></a>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <ul class="nav nav-tabs" id="loginAndRegistrationTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true"><?php echo e(__('messages.Login')); ?></a>
                    </li>
                    <li class="nav-item">
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password">
                            ...
                            <div class="form-group form-check">
                                ...
                                <label class="form-check-label" for="remember">
                                    <?php echo e(__('messages.RememberMe')); ?>

                                </label>
                            </div>

                            <button type="submit" class="btn btn-light"><?php echo e(__('messages.Login')); ?></button>
                        </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="registration" role="tabpanel" aria-labelledby="registration-tab">
                        <form method="POST" action="/Registration" onsubmit="validateLoginForm(event);">
                            ...
                            <button type="submit" class="btn btn-light"><?php echo e(__('messages.Regisztration')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
</script><?php /**PATH /home/vagrant/code/AH/resources/views/UnLoginMenu.blade.php ENDPATH**/ ?>