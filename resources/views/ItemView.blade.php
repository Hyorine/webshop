<div class="ItemOperationParentDiv">
    <div class="ItemOperationList">
        ...
        <li onclick="ProductOperation(3)">{{ __('messages.OTR') }}</li>
        <li onclick="ProductOperation(1)">{{ __('messages.THA') }}</li>
        <li>{{ __('messages.Statisztika') }}</li>
        <li>{{ __('messages.Export') }}</li>
        </ul>
    </div>
    <div id="ItemOperations" class="Items-Right-Side">
        @include('ItemOperation')
    </div>
</div>
<script>
